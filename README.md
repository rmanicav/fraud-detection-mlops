...
The project uses stratified cross-validation to evaluate model stability.
...
A threshold search is also performed to examine the trade-off between fraud detection recall and false positives.

> **Important:** The dataset is synthetic and the fraud labels are generated from predefined rules. The results demonstrate the ML/MLOps workflow and should not be interpreted as production fraud-detection performance.
